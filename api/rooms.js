...
module.exports = async (req, res) => {
  if (req.method === 'POST') {
    ...
    const { reservation_id,reserve_date, time, businessunit, room, setup, guest, contact, email, table, hdmi, extension, message } = req.body;
    ...
    try {
      ...
      try {
        ...
        const result = await client.query(
          `INSERT INTO reservations (reserve_date, time, setup, business_unit, room, guest, contact, email, "table", hdmi, extension, message, reservation_id)
